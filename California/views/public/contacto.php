    ...
    <div id="index-banner" class="parallax-container valign-wrapper">
        ...
        <div class="section no-pad-bot ">
          <div class="container">
            <br><br>
            <div class="row">            
              <h3 class="header col s12 center light Subtitulos">Queremos estar cerca tuyo.</h3>
            </div>
            <br><br>
          </div>
        </div>
        <!--Imagen del parallax-->
        <div class="parallax">
          <img src="../../resources/multimedia/CoverSKTB (15).png" alt="Unsplashed background img 1">
        </div>
      </div>
      <br><br>
</section>
<section>
    <div>
        <br><br>
        <h2 class="pad-nav Texto center">Contactanos</h2>
        <br><br><br>
      </div>
      <div class="container">
          <div class="row">
...
<section>
    <div>
        <br><br>
        <h2 class="pad-nav Texto center">Preguntas Frecuentes</h2>
        <br><br><br>
    </div>
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12">
                <ul class="collapsible">
                    <li>
                      <div class="collapsible-header">¿Cómo puedo hacer mi pago?</div>
                      <div class="collapsible-body"><span>La forma de pago predeterminada es la contra entrega en efectivo. En el futuro podrás pagar con tu tarjeta de una manera más sencillas.</span></div>
                    </li>
                    <li>
                      <div class="collapsible-header">¿Y la seguridad?</div>
                      <div class="collapsible-body">
                        <span>Como empresa la seguridad es algo muy importante, por lo que te aseguramos que todas las transacciones se harán lo más transparentes posibles. Pero podemos hacerte unas recomendaciones:</span>
                        <ul>
                            <li><br>-Elige lugares seguros y publicos como centros comerciales, plazas, parques, etc.</li>
                            <li>-Que alguien te acompañe el día de la entrega</li>
                            <li>-Verifica los datos de la entrega y solicitalos a quien te este entregando nuestros paquetes</li>
                        </ul>
                        <span><br>Aún así, trabajamos duro para brindarte los pasos más seguros en la entrega.</span>
                      </div>
                    </li>
                    <li>
                      <div class="collapsible-header">¿Puedo hacer devoluciones o cambios?</div>
                      <div class="collapsible-body"><span>No aceptamos devoluciones ni cambios, así que te pedimos que realices una buena compra.</span></div>
                    </li>
                  </ul>
            </div>
        </div>
