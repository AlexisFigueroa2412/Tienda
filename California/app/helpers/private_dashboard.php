...
class Dashboard_Page {
    ...
    public static function headerTemplate($title) {
        ...
        <html lang="es">
            ...
            <!--Importar css propio-->   
            <link type="text/css" rel="stylesheet" href="../../resources/css/california.css"/>
            <!--Importar Jquery(al ponerlo abajo no funciona)-->
            <script type="text/javascript" src="../../resources/js/jquery.js"></script>

            <!--Para que sea resposivo-->
            <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
            <title>'.$title.'California</title>
            </head>
    ...
    public static function footerTemplate() {
        print('
                ...
                <script type="text/javascript" src="../../app/init/california_priv.js"></script> 
                <script type="text/javascript" src="../../resources/js/publicsite.js"></script> 
            </body>
            </html>
        ');
    }
