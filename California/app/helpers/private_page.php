            ...
            if ($filename != 'index.php' && $filename != 'register.php' && $filename != 'factor.php' && $filename != 'restaurar.php' && $filename !='clave.php') {
                ...
                <div class="navbar-fixed">
                    ...
                    <ul id="DropdownSesion" class="dropdown-content">
                        ...
                        <!--<li><a href="#"  class="pad-nav Subtitulos black-text" onclick="openPasswordDialog()">Cambiar clave</a></li>
                        -->
                        <li><a href="cambiar_clave.php"  class="pad-nav Subtitulos black-text">Cambiar clave</a></li>
                    ...
                    <div class="nav-wrapper white">---
                        ...
                        <ul class="right hide-on-med-and-down">                    
                            ...
                            <li><a href="#!" class="pad-nav Subtitulos black-text dropdown-trigger" data-target="DropdownSesion">Cuenta</a></li>
        ...
        print('
            ...
            <div id="password-modal" class="modal">
                <div class="modal-content">
                    ...
                    <form method="post" id="password-form2">
                        <div class="row">
                            <div class="input-field col s12 m6 offset-m3">
                                <i class="material-icons prefix">security</i>
                                <input id="clave_actual2" type="password" name="clave_actual2" class="validate" required/>
                                <label for="clave_actual2">Clave actual</label>
                            </div>
                        </div>
                        <div class="row center-align">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m6">
                                <i class="material-icons prefix">security</i>
                                <input id="clave_nueva_12" type="password" name="clave_nueva_1" class="validate" required/>
                                <label for="clave_nueva_12">Clave</label>
                            </div>
                            <div class="input-field col s12 m6">
                                <i class="material-icons prefix">security</i>
                                <input id="clave_nueva_22" type="password" name="clave_nueva_2" class="validate" required/>
                                <label for="clave_nueva_22">Confirmar clave</label>
                            </div>
                        </div>
                        <div class="row center-align">
                            <a href="#" class="btn waves-effect grey tooltipped modal-close" data-tooltip="Cancelar"><i class="material-icons">cancel</i></a>
