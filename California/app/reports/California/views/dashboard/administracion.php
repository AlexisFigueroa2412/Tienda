                    ...
                    <div class="card-content Texto">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l12">
                                ...
                                <input placeholder="Buscar Categoría" id="first_name" type="text" class="validate">
                                <label for="first_name">Categoría</label>
                            </div>                            
                        </div>
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <a href="#addcat" class="modal-trigger waves-effect waves-light col s12 black btn"><i class="material-icons left">add_box</i>Añadir nueva Categoría</a>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <table class="striped white black-text">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Tablas</td>                                           
                                            <td>
                                                <a href='#' data-target='dropdowncategoria'
                                ...
                                <table class="striped white black-text">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Skateboard</td>                                          
                                            <td>
                                                <a href='#' data-target='dropdownsubcategoria'
                                                    class="dropdown-trigger right btn-floating btn-large waves-effect waves-dark transparent z-depth-0">
                                                    <i class="large material-icons black-text hoverable">more_vert</i></a>
                                            </td>
                                        </tr>
                                ...
                                <table class="striped white black-text">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Viernes</td>                                    
                                            <td>
                                                <a href='#' data-target='dropdownnoticia'
                                                    class="dropdown-trigger right btn-floating btn-large waves-effect waves-dark transparent z-depth-0">
                                                    <i class="large material-icons black-text hoverable">more_vert</i></a>
                                            </td>
                                        </tr>
